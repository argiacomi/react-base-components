...
export default function DrawerDemo() {
  return (
    <Stack spacing={5} direction='column' sx={{ mx: 'auto', maxWidth: 800, marginBottom: '2rem' }}>
      <Stack display='inline-block' width='fit-content' spacing={1} direction='column'>
        <Text variant='h6'>Temporary Drawer</Text>
        <SwipeTemporaryDrawer />
      </Stack>
      <Stack display='inline-block' width='fit-content' spacing={1} direction='column'>
        <Text variant='h6'>Swipeable Edge Drawer</Text>
        <SwipeEdgeDrawer />
      </Stack>
      <Stack display='inline-block' width='fit-content' spacing={1} direction='column'>
        <Text variant='h6'>Responsive Drawer</Text>
        <ResponsiveDrawer />
      </Stack>
      <Stack display='inline-block' width='fit-content' spacing={1} direction='column'>
        <Text variant='h6'>Persistent Drawer</Text>
        <PersistentDrawer />
      </Stack>
      <Stack display='inline-block' width='fit-content' spacing={1} direction='column'>
        <Text variant='h6'>Mini Variant Drawer</Text>
        <MiniDrawer />
      </Stack>
    </Stack>
  );
