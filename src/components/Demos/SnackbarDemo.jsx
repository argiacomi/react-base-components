...
//   console.log(useSnackbarQueue());
//   console.log(addSnackbar);
...
//   const queueButtons = (
//     <React.Fragment>
//       <Button onClick={handleClickFive}>Show snackbar</Button>
//       <Button onClick={handleClickVariant('success')}>Show success snackbar</Button>
//     </React.Fragment>
//   );
...
//         />
//       </Stack>
//       <SnackbarProvider maxSnack={3}>{queueButtons}</SnackbarProvider>
//     </Stack>
//   );
// }
