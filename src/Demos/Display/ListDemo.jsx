...
export default function ListDemo() {
  return (
    <Stack spacing={5} direction='column'>
      <Stack display='inline-block' spacing={1} direction='column'>
        <Text variant='h6'>Basic List</Text>
        <BasicList />
      </Stack>
      <Stack display='inline-block' spacing={1} direction='column'>
        <Text variant='h6'>Nested List</Text>
        <NestedList />
      </Stack>
      <Stack display='inline-block' spacing={1} direction='column'>
        <Text variant='h6'>Folder List</Text>
        <FolderList />
      </Stack>
      <Stack display='inline-block' spacing={1} direction='column'>
        <Text variant='h6'>Interactive List</Text>
        <InteractiveList />
      </Stack>
      <Stack display='inline-block' spacing={1} direction='column'>
        <Text variant='h6'>Selected List Item</Text>
        <SelectedListItem />
      </Stack>
      <Stack display='inline-block' spacing={1} direction='column'>
        <Text variant='h6'>Align List Items</Text>
        <AlignItemsList />
      </Stack>
      <Stack display='inline-block' spacing={1} direction='column'>
        <Text variant='h6'>List Controls - Checkbox</Text>
        <CheckboxList />
        <Text variant='h6'>List Controls - Checkbox Secondary</Text>
        <CheckboxListSecondary />
      </Stack>
      <Stack display='inline-block' spacing={1} direction='column'>
        <Text variant='h6'>List Controls - Switch</Text>
        <SwitchListSecondary />
      </Stack>
      <Stack display='inline-block' spacing={1} direction='column'>
        <Text variant='h6'>Sticky Subheaders</Text>
        <PinnedSubheaderList />
      </Stack>
      <Stack display='inline-block' spacing={1} direction='column'>
        <Text variant='h6'>Inset List Item</Text>
        <InsetList />
      </Stack>
      <Stack display='inline-block' spacing={1} direction='column'>
        <Text variant='h6'>Virtualized List</Text>
        <VirtualizedList />
      </Stack>
      {/* <Stack display='inline-block' spacing={1} direction='column'>
        <Text variant='h6'>Customized List</Text>
        <CustomizedList />
      </Stack> */}
    </Stack>
  );
