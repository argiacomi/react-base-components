...
function CircularIntegration() {
  ...
  return (
    <Box css={{ display: 'flex', alignItems: 'center' }}>
      <Box css={{ margin: '.5rem', position: 'relative' }}>
      ...
      <Box css={{ margin: '.5rem', position: 'relative' }}>
        <Button variant='contained' css={buttonSx} disabled={loading} onClick={handleButtonClick}>
          Accept terms
        </Button>
        {loading && (
          <CircularProgress
...
function LinearColor() {
  return (
    <Stack css={{ width: '100%', color: 'gray' }} spacing={2}>
